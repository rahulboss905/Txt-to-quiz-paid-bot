...
def main() -> None:
    ...
    application.add_handler(CommandHandler("plans", plans_command))  # New command
    application.add_handler(CommandHandler("setplan", set_plan_command))  # New command
